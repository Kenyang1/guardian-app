...
export default function MainTabs() {
  ...
  return <SafeAreaView style={[styles.root, desktop && styles.desktopRoot]} edges={['bottom']}>
    {desktop ? <View style={[styles.sidebar, { backgroundColor: theme.tabBar, borderRightColor: theme.border }]}><ThemedText style={[styles.logo, { color: theme.primary }]}>Guardian</ThemedText><Nav theme={theme} tab={tab} setTab={selectTab} desktop /></View> : null}
